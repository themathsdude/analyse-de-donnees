...
Log_salaire et Runs_over_longevity. Le nuage de points semble + centré autour
d'une éventuelle droite que celui du salaire, qui serait + utile pour de la 
classification.
...
Les résidus sont toujours bien normaux. Pour les valeurs aberrantes, on observe
